...
/* Justified text for strategy paragraphs */
.justified-text { 
    text-align: justify; 
...
/* Custom styling for the markdown tables generated by AI */
...
/* ========================================= */
/* MOBILE SPECIFIC CSS (Android & iPhone View) */
/* ========================================= */
.mobile-banner { display: none; } /* Hidden by default on desktop */

@media (max-width: 768px) {
    /* Show the mobile instruction banner */
    .mobile-banner { 
    ...
    /* Force tables to be swipeable instead of shrinking/breaking screen width */
    table { 
        display: block; 
        overflow-x: auto; 
        white-space: nowrap; 
    }
    /* Adjust text size for readability on small screens */
    .justified-text { font-size: 14px; }
}
</style>
